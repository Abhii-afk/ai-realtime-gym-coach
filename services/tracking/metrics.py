...
from services.coaching.voice_pipeline import store_coaching_result
...
def sync_metrics_update(context):
    ...
    if reps_per_set > 0 and target_sets > 0:
        ...
        current_sets_reps = reps % reps_per_set
    ...
    st.session_state.current_set_reps = current_sets_reps
